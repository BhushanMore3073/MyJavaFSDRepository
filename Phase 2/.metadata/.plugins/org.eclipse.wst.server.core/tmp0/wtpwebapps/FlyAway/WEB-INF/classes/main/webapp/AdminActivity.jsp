			...
			<table>
				...
				<tr>
					<td align="center" colspan="2">
						<input type="submit" value="Add" name="b1" class="button-8">
						<input type="submit" value="Display"name="b1" class="button-8">
						<input type="submit" value="Delete" name="b1" class="button-8">
					</td>
				</tr>
			</table>
		</form>
